...
jobname = "3DSMI"      # used to create a sub directory
...
params = {
    ...
    "gen_batch_size": 100,
    "block_size": 100,
    "generation_epoch": 5,  # <-- which model to use (i.e. which epoch)
    "n_samples": 200,       # <-- how many structures to generate
    ...
    "sigma": 20,
    "alpha": 0.5,
    "score_type": "3D_SMI",  #"reduce", "augment", "qed", "activity","3D_SMI","docking_score","SA"
}
