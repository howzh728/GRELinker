...
def evaluate_model(valid_dataloader, train_dataloader, nll_per_action, model, epoch_key=None):
...
def evaluate_generated_graphs(generated_graphs, termination, nlls, start_time,
                              ts_properties, generation_batch_idx, epoch_key=None):
...
def get_validation_nll(dataloader, model):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        apd,_,_ = model(nodes, edges,nodes,edges)
        normalized_output = Softmax(apd)
