...
class Connect_nodes(gnn.summation_mpnn.SummationlinkerMPNN):
    def __init__(self, edge_features, enn_depth, enn_dropout_p, enn_hidden_dim,
        ...
        super(Connect_nodes, self).__init__(node_features, hidden_node_features, edge_features, message_size, message_passes)
        ...
        self.ConnReadout = gnn.modules.LinkerGlobalReadout(
    ...
    def globalreadout(self,hidden_nodes,graph_embeddings):

        conn_output = self.ConnReadout(hidden_nodes, graph_embeddings)
        return conn_output,conn_output,conn_output
